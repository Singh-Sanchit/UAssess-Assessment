...
const skillGroupCollection = mongoose.Schema({
    ...
    templateRoleIds: { type: Array, require: false, default: []},
...
module.exports = mongoose.model('skillGroups', skillGroupCollection);