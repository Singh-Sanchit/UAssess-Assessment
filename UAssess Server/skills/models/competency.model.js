...
const competencyCollection = mongoose.Schema({
    ...
    subCompetencyIds: { type: Array, require: false, default: []},
...
module.exports = mongoose.model('competencies', competencyCollection);