...
import {Col,Row,Label,Form,FormGroup,Input,Button,ButtonDropdown,DropdownItem,DropdownMenu,DropdownToggle } from 'reactstrap';
...
class AssesseeLogin extends React.Component {
        ...
        .then(data => {
          ...
          { 
              ...
              if(array.indexOf("Assessee") !== -1){
                    ...
                    sessionStorage.setItem('role', 'Assessee'); 
    ...
    const isEnabled = this.canBeSubmitted();
     ...
     return (<Router> 
      ...
      <div>
        ...
        <div className="singin-title">Sign in to start your Assessment</div>
        <p className="login-container__form-status">{this.state.status}</p>
          <Form >
            ...
            <Row >
              ...
              <Col xs={12} sm={12} md={6} lg={6} xl={6}><a className="login-container__create-acc" href="/register"><span>Create account</span></a></Col>
            </Row>              
          </Form>
          </div>
        </div>
